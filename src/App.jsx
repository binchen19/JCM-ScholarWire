...
// Ask Claude to look up all new dates for you.
// ──────────────────────────────────────────────
const DEFAULT_CONFERENCES = [
  ...
  { id: 10, name: "CIRC", fullName: "23rd Chinese Internet Research Conference", location: "Edmonton, Canada", dates: "Jun 22–23, 2026", startDate: "2026-06-22", cfpDeadline: "2026-03-01", cfpNote: "500-word abstracts or full panel proposals", url: "https://www.ualberta.ca/en/china-institute/events/latest/2026/circ/index.html" },
  { id: 4, name: "SM+Society", fullName: "Intl Conf. on Social Media & Society", location: "Glasgow, UK", dates: "Jul 13–15, 2026", startDate: "2026-07-13", cfpDeadline: "2026-01-26", cfpNote: "Extended abstracts (1000–1500 words)", url: "https://socialmediaandsociety.org/smsociety-2026/" },
  { id: 5, name: "IC2S2", fullName: "12th Intl Conf. on Computational Social Science", location: "Burlington, VT", dates: "Jul 28–31, 2026", startDate: "2026-07-28", cfpDeadline: "2026-03-03", cfpNote: "Extended abstracts (max 2 pages)", url: "https://ic2s2-2026.org/" },
  { id: 6, name: "AEJMC", fullName: "2026 AEJMC Annual Conference", location: "New Orleans, LA", dates: "Aug 5–8, 2026", startDate: "2026-08-05", cfpDeadline: "2026-04-01", cfpNote: "Research papers & extended abstracts", url: "https://www.aejmc.org/aejmc-events/conference" },
  { id: 7, name: "APSA", fullName: "122nd American Political Science Association Meeting", location: "Boston, MA", dates: "Sep 3–6, 2026", startDate: "2026-09-03", cfpDeadline: "2026-01-14", cfpNote: "Papers, panels & roundtables", url: "https://connect.apsanet.org/apsa2026/" },
  { id: 8, name: "IJPP", fullName: "IJPP Annual Conference (TBA)", location: "TBA", dates: "Oct 2026 (TBA)", startDate: "2026-10-15", cfpDeadline: "", cfpNote: "Check journal website", url: "https://journals.sagepub.com/home/hij/" },
  { id: 9, name: "NCA", fullName: "112th National Communication Association Convention", location: "New Orleans, LA", dates: "Nov 19–22, 2026", startDate: "2026-11-19", cfpDeadline: "2026-03-25", cfpNote: "Papers, panels & posters", url: "https://www.natcom.org/nca-112th-annual-convention/" },
];
      ...
      <div style={{ display: "flex", alignItems: "flex-start", gap: 14 }}>
        ...
        <div style={{ flex: 1, minWidth: 0 }}>
          <div style={{ display: "flex", alignItems: "center", gap: 8, flexWrap: "wrap", marginBottom: 6 }}>
            ...
            {article.open_access && <Badge color="#2A9D8F">OA</Badge>}
    ...
    <div style={{ borderBottom: "1px solid #eee", padding: "16px 0", opacity: isPast ? 0.45 : 1 }}>
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start" }}>
        <div style={{ flex: 1 }}>
          ...
          {cfp.deadline && <p style={{ fontSize: 11, color: isPast ? "#999" : "#E63946", margin: "0 0 4px", fontFamily: "'JetBrains Mono', monospace" }}>✏️ Deadline: {formatDate(cfp.deadline)}</p>}
...
export default function JournalTracker() {
  ...
  const inputStyle = { width: "100%", padding: "8px 10px", fontSize: 13, border: "1px solid #ddd", borderRadius: 3, fontFamily: mono, boxSizing: "border-box", outline: "none" };
  const labelStyle = { fontSize: 11, fontWeight: 700, color: "#999", marginBottom: 4, display: "block", fontFamily: mono, textTransform: "uppercase", letterSpacing: "0.5px" };
  const btnPrimary = { background: "#E63946", color: "#fff", border: "none", padding: "8px 20px", borderRadius: 3, cursor: "pointer", fontSize: 12, fontWeight: 700, fontFamily: mono, letterSpacing: "0.5px" };
  const btnSecondary = { background: "#fff", color: "#333", border: "1px solid #ddd", padding: "8px 20px", borderRadius: 3, cursor: "pointer", fontSize: 12, fontWeight: 600, fontFamily: mono };
  ...
  // Table cell styles
  const th = { padding: "8px 10px", textAlign: "left", fontSize: 10, fontWeight: 700, color: "#999", textTransform: "uppercase", letterSpacing: "0.5px", fontFamily: mono, borderBottom: "2px solid #1a1a1a", whiteSpace: "nowrap" };
  const td = { padding: "8px 10px", fontSize: 12, fontFamily: mono, borderBottom: "1px solid #eee", verticalAlign: "top", lineHeight: 1.4 };

  return (
    <div style={{ fontFamily: serif, maxWidth: 900, margin: "0 auto", padding: "0 20px", minHeight: "100vh" }}>
      <style>{`
        ...
        * { box-sizing: border-box; } ::selection { background: #E63946; color: #fff; }
        .conf-table tr:hover { background: #fafafa; }
      `}</style>

      <header style={{ borderBottom: "3px solid #1a1a1a", paddingTop: 32, paddingBottom: 16 }}>
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-end" }}>
          <div>
            <h1 style={{ fontSize: 28, fontWeight: 700, margin: 0, letterSpacing: "-0.5px", fontFamily: serif, color: "#1a1a1a" }}>JCM ScholarWire</h1>
            <p style={{ fontSize: 11, color: "#999", margin: "4px 0 0", fontFamily: mono, textTransform: "uppercase", letterSpacing: "1px" }}>Journalism, Communication & Media Research Tracker</p>
          </div>
      ...
      <div style={{ display: "flex", gap: 0, borderBottom: "1px solid #eee", padding: "12px 0" }}>
        {[{ label: "Articles", value: totalArticles }, { label: "New this week", value: newThisWeek }, { label: "Open Access", value: oaCount }, { label: "Journals", value: journals.length }, { label: "Upcoming", value: upcomingConfCount }].map((s, i) => (
          <div key={i} style={{ flex: 1, textAlign: "center", borderRight: i < 4 ? "1px solid #eee" : "none" }}>
            <div style={{ fontSize: 20, fontWeight: 700, color: "#1a1a1a", fontFamily: serif }}>{s.value}</div>
            <div style={{ fontSize: 9, color: "#aaa", textTransform: "uppercase", fontFamily: mono, letterSpacing: "0.5px" }}>{s.label}</div>
          </div>
        ))}
      </div>
      ...
      {tab === "Feed" && (
        <div style={{ animation: "fadeIn 0.3s ease" }}>
          <div style={{ display: "flex", gap: 10, padding: "14px 0", borderBottom: "1px solid #eee", flexWrap: "wrap", alignItems: "center" }}>
            <input type="text" placeholder="Search titles, authors…" value={searchTerm} onChange={e => setSearchTerm(e.target.value)} style={{ ...inputStyle, flex: "1 1 200px", minWidth: 180 }} />
          ...
          {loading && <Spinner />}
          {fetchError && <p style={{ textAlign: "center", color: "#999", padding: "30px 0", fontSize: 13, fontFamily: mono }}>{fetchError}</p>}
          ...
          {!loading && !fetchError && filteredArticles.length === 0 && articles.length > 0 && <p style={{ textAlign: "center", color: "#999", padding: "30px 0", fontSize: 13, fontFamily: mono }}>No articles match your filters.</p>}
        </div>
      )}
      ...
      {tab === "Journals" && (
        <div style={{ animation: "fadeIn 0.3s ease", padding: "16px 0" }}>
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 16 }}>
            <p style={{ fontSize: 12, color: "#999", margin: 0, fontFamily: mono }}>Manage your tracked journals. Articles fetched via OpenAlex.</p>
          ...
          {showAddJournal && (
            <div style={{ background: "#fafafa", border: "1px solid #eee", borderRadius: 4, padding: 16, marginBottom: 16 }}>
              ...
              <p style={{ fontSize: 11, color: "#aaa", marginTop: 8, fontFamily: mono }}>Find ISSNs at <a href="https://portal.issn.org" target="_blank" rel="noopener noreferrer" style={{ color: "#E63946" }}>portal.issn.org</a>. Use both print & online ISSNs separated by comma.</p>
            </div>
          )}
          {journals.map(j => (
            <div key={j.issn} style={{ display: "flex", alignItems: "center", justifyContent: "space-between", padding: "12px 0", borderBottom: "1px solid #eee" }}>
              <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
                ...
                <div>
                  <div style={{ fontSize: 14, fontWeight: 600, fontFamily: serif }}>{j.name}</div>
                  <div style={{ fontSize: 11, color: "#aaa", fontFamily: mono }}>ISSN: {j.issn}{stats[j.name] !== undefined && ` · ${stats[j.name]} articles`}</div>
                </div>
              </div>
              <button onClick={() => setJournals(journals.filter(x => x.issn !== j.issn))} style={{ background: "none", border: "1px solid #eee", borderRadius: 3, padding: "4px 12px", cursor: "pointer", color: "#999", fontSize: 11, fontFamily: mono }}
      ...
      {tab === "Conferences" && (
        <div style={{ animation: "fadeIn 0.3s ease", padding: "16px 0" }}>
            ...
            <div style={{ background: "#fafafa", border: "1px solid #eee", borderRadius: 4, padding: 16, marginBottom: 16 }}>
              <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
                <div style={{ display: "flex", gap: 10, flexWrap: "wrap" }}>
                  ...
                  <div style={{ flex: "1 1 250px" }}><label style={labelStyle}>Full Name</label><input value={newConf.fullName} onChange={e => setNewConf({ ...newConf, fullName: e.target.value })} placeholder="e.g. World Association for Public Opinion Research" style={inputStyle} /></div>
                  <div style={{ flex: "0 1 160px" }}><label style={labelStyle}>Location</label><input value={newConf.location} onChange={e => setNewConf({ ...newConf, location: e.target.value })} placeholder="e.g. Berlin, Germany" style={inputStyle} /></div>
                </div>
                <div style={{ display: "flex", gap: 10, flexWrap: "wrap" }}>
                  ...
                  <div style={{ flex: "0 1 150px" }}><label style={labelStyle}>CFP Deadline</label><input type="date" value={newConf.cfpDeadline} onChange={e => setNewConf({ ...newConf, cfpDeadline: e.target.value })} style={inputStyle} /></div>
                  <div style={{ flex: "1 1 200px" }}><label style={labelStyle}>CFP Note</label><input value={newConf.cfpNote} onChange={e => setNewConf({ ...newConf, cfpNote: e.target.value })} placeholder="e.g. Full papers" style={inputStyle} /></div>
                </div>
          ...
          <div style={{ overflowX: "auto" }}>
            <table className="conf-table" style={{ width: "100%", borderCollapse: "collapse" }}>
              <thead>
                <tr>
                  <th style={th}>Conference</th>
                  <th style={th}>Dates</th>
                  <th style={th}>Location</th>
                  <th style={th}>CFP Deadline</th>
              ...
              <tbody>
                {filteredConfs.map(c => {
                  ...
                  return (
                    <tr key={c.id} style={{ opacity: isPast ? 0.45 : 1 }}>
                      <td style={td}>
                        <div style={{ fontWeight: 700, fontSize: 13, color: "#1a1a1a" }}>{c.name}</div>
                        <div style={{ fontSize: 11, color: "#888", lineHeight: 1.3 }}>
                          {c.url ? <a href={c.url} target="_blank" rel="noopener noreferrer" style={{ color: "#457B9D", textDecoration: "none" }}>{c.fullName}</a> : c.fullName}
                        </div>
                      </td>
                      <td style={{ ...td, whiteSpace: "nowrap", fontSize: 11 }}>{c.dates}</td>
                      <td style={{ ...td, fontSize: 11 }}>{c.location}</td>
                      <td style={{ ...td, whiteSpace: "nowrap", fontSize: 11, color: isPastCfp ? "#999" : "#E63946", textDecoration: isPastCfp ? "line-through" : "none" }}>
                        {c.cfpDeadline ? shortDate(c.cfpDeadline) : "TBA"}
                      </td>
                      <td style={{ ...td, whiteSpace: "nowrap" }}>
                        {isPast ? <Badge color="#999">Past</Badge> :
                          !isPastCfp && c.cfpDeadline ? (
                            cfpDays <= 14 ? <Badge color="#E63946">{cfpDays}d</Badge> :
                            cfpDays <= 30 ? <Badge color="#F4A261">{cfpDays}d</Badge> :
                            <Badge color="#457B9D">Open</Badge>
                          ) : c.cfpDeadline ? <Badge color="#999">Closed</Badge> :
      ...
      {tab === "CFPs" && (
        <div style={{ animation: "fadeIn 0.3s ease", padding: "16px 0" }}>
          ...
          <p style={{ fontSize: 12, color: "#999", margin: "0 0 12px", fontFamily: mono }}>Track special issue calls, workshop CFPs, and other opportunities.</p>
          {showAddCfp && (
            <div style={{ background: "#fafafa", border: "1px solid #eee", borderRadius: 4, padding: 16, marginBottom: 16 }}>
              <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
                ...
                <div style={{ display: "flex", gap: 10, flexWrap: "wrap" }}>
                  <div style={{ flex: "0 1 140px" }}><label style={labelStyle}>Type</label><select value={newCfp.type} onChange={e => setNewCfp({ ...newCfp, type: e.target.value })} style={{ ...inputStyle, cursor: "pointer" }}><option>Special Issue</option><option>Workshop</option><option>Fellowship</option><option>Other</option></select></div>
                  ...
                  <div style={{ flex: "0 1 150px" }}><label style={labelStyle}>Deadline</label><input type="date" value={newCfp.deadline} onChange={e => setNewCfp({ ...newCfp, deadline: e.target.value })} style={inputStyle} /></div>
                </div>
          ...
          {filteredCfps.length === 0 && (
            <div style={{ textAlign: "center", padding: "40px 20px", color: "#bbb", fontFamily: mono, fontSize: 12 }}>
              <div style={{ fontSize: 32, marginBottom: 10 }}>📭</div>
              No {cfpFilter !== "all" ? cfpFilter : ""} CFPs yet.
            </div>
          )}
      ...
      <footer style={{ borderTop: "1px solid #eee", padding: "16px 0 32px", marginTop: 32, textAlign: "center" }}>
        <p style={{ fontSize: 10, color: "#ccc", fontFamily: mono, textTransform: "uppercase", letterSpacing: "0.5px" }}>
